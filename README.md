...
| /设置类型     | /设置类型 <模型type参数> <模型model参数> | 切换使用的模型以及数据风格（默认是配置文件中的设置），详细的选项可以在 [码本AI详情](https://www.lingyuzhao.top/b/Article/377388518747589#model%20%E5%8F%82%E6%95%B0)查询 |
